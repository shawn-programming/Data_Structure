...
// 	//cout << disjSets.parentVec[0] << disjSets.parentVec[1] << disjSets.parentVec[2] << disjSets.parentVec[3] << disjSets.parentVec[4] << disjSets.parentVec[5] << disjSets.parentVec[6] << disjSets.parentVec[7] << endl;
